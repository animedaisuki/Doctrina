    ...
    <div class="container">
        <nav class="navbar-flex-nav">
                ...
                <ul class="navbar-drop-down">
                    <div class="navbar-major-programming">
                        ...
                        <ul class="navbar-drop-down-small">
                            ...
                            <div>
                                <a href="<?php echo base_url(); ?>Category?Major=mybatis">
                                    <li>Mybatis</li>
                                </a>
                            </div>
                            <div>
                                <a href="<?php echo base_url(); ?>Category?Major=codeigniter">
                                    <li>CodeIgniter</li>
                                </a>
                            </div>
                            <div>
                                <a href="<?php echo base_url(); ?>Category?Major=webdevelopment">
            ...
            <div class="navbar-searchbar-container">
                ...
                <input type="text" name="auto" id="auto" placeholder="search by Course Name">
                <?php echo form_close();?>
            </div>
