        ...
        <div class="container">
            <nav class="navbar-flex-nav">
                <div class="navbar-logo-container">
                    <a href="<?php echo base_url(); ?>home"><img  src="<?php echo base_url(); ?>assets/img/logo-w.png" alt="" class="navbar-logo"></a>
                </div>
                ...
                <ul class="navbar-navbar-container">
                    <a href="<?php echo base_url(); ?>about_us"  class="about-us"><li>About us</li></a>

                    <?php if(!$this->session->userdata('login')) : ?>
                    <div class="navbar-login-signup">
                        <a href="<?php echo base_url(); ?>login" id="navbar-login"><li >Login</li></a>
                        <a href="<?php echo base_url(); ?>Signup" id="navbar-signup"><li>Sign up</li></a>
                    </div>
                    <?php endif; ?>
